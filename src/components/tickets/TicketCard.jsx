...
import { Wrench, Package, User, CalendarDays, MessageCircle } from "lucide-react";
...
export default function TicketCard({ ticket, customerName, technicianName, onConvert, onCardClick }) {
    ...
    const getTimeAgo = (date) => {
        ...
        return createdDate ? formatDistanceToNow(new Date(createdDate), { addSuffix: true }) : '—';
                ...
                <CardHeader>
                    <div className="flex justify-between items-start">
                        ...
                        <div className="flex flex-col items-end gap-2">
                            ...
                            {ticket.last_reply_role === 'customer' && (
