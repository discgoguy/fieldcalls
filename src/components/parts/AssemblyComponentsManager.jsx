                            ...
                            return (
                                <div key={index} className="grid grid-cols-12 gap-2 items-end p-3 border rounded-lg bg-slate-50">
                                    <div className="col-span-7">
                                        ...
                                        {selectedPart && (
                                            <p className={`text-xs font-semibold mt-1 ${selectedPart.quantity_in_inventory >= component.quantity_required ? 'text-black' : 'text-red-600'}`}>
                                                In stock: {selectedPart.quantity_in_inventory}
                                            </p>
                                        )}
                                    </div>
